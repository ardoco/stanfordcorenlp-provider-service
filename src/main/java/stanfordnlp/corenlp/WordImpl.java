...
class WordImpl implements Word {
    ...
    WordImpl(CoreLabel token, int index, TextImpl parent) {
        ...
        this.posTag = PosTag.forValue(token.get(CoreAnnotations.PartOfSpeechAnnotation.class));
    }
    ...
    private List<TypedDependency> getDependenciesOfType(DependencyType dependencyTag) {
